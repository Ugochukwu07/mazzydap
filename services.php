...
<img src="<?php echo BASE_URL . '/assets/open/images/'; ?>service/graphic-design.jpg" alt="image" class="img-fluid no-shadow"/>
</div>
</div>
...
<img src="<?php echo BASE_URL . '/assets/open/images/'; ?>service/branding-.jpg" alt="image" class="img-fluid no-shadow"/>
</div>
</div>
</div>
</div>
...
<div class="s-card-icon-large"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>service/logo-design.jpg" alt="service" class="img-fluid"/></div>
...
<div class="s-block wide-sblock">
  <div class="s-card-icon-large"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>service/packaging-design.jpg" alt="service" class="img-fluid"/></div>
  <div class="s-block-content-large">
...
<div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".6s">
  <div class="s-block wide-sblock">
    <div class="s-card-icon-large"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>service/brochure-.jpg" alt="service" class="img-fluid"/></div>
    <div class="s-block-content-large">
  ...
  <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".8s">
    <div class="s-block wide-sblock">
      <div class="s-card-icon-large"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>service/flyer-.jpg" alt="service" class="img-fluid"/></div>
      <div class="s-block-content-large">
        <h4>Flyer Design</h4>
        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
      </div></div>
    ...
    <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay="1s">
      <div class="s-block wide-sblock">
        <div class="s-card-icon-large"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>service/newsletter.jpg" alt="service" class="img-fluid"/></div>
        <div class="s-block-content-large">
      ...
      <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay="1.2s">
        <div class="s-block wide-sblock">
          <div class="s-card-icon-large"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>service/visit-card.jpg" alt="service" class="img-fluid"/></div>
          <div class="s-block-content-large">
  ...
  <section class="service-block pad-tb light-dark">
    <div class="container">
      ...
      <div class="row upset justify-content-center mt60">
        <div class="col-lg-4 v-center order1">
          <div class="image-block1">
            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>process/process-1.jpg" alt="Process" class="img-fluid"/>
          </div>
        </div>
      ...
      <div class="row upset justify-content-center mt60">
        ...
        <div class="col-lg-4 v-center order1">
          <div class="image-block1">
            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>process/process-2.jpg" alt="Process" class="img-fluid"/>
          </div>
        </div>
      </div>
      <div class="row upset justify-content-center mt60">
        <div class="col-lg-4 v-center order1">
          <div class="image-block1">
            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>process/process-3.jpg" alt="Process" class="img-fluid"/>
          </div>
        </div>
        <div class="col-lg-7 v-center order2">
          <div class="ps-block">
      ...
      <div class="row upset justify-content-center mt60">
        ...
        <div class="col-lg-4 v-center order1">
          <div class="image-block1">
            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>process/process-4.jpg" alt="Process" class="img-fluid"/>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/teama.svg" alt="service" class="img-fluid"></div>
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/link.svg" alt="service" class="img-fluid"></div>
            <div class="s-block-content">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/tech.svg" alt="service" class="img-fluid"></div>
            <div class="s-block-content">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/hi.svg" alt="service" class="img-fluid"></div>
            <div class="s-block-content">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/badge.svg" alt="service" class="img-fluid"></div>
            <div class="s-block-content">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/tin.svg" alt="service" class="img-fluid"></div>
            <div class="s-block-content">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6">
          <div class="pricing-table mt60">
            <div class="inner-table">
              <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/plan-1.svg" alt="Personal"/>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="pricing-table best-plan mt60 bg-gradient4">
            <div class="inner-table">
              <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/plan-2.svg" alt="Advance"/>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="pricing-table mt60">
            <div class="inner-table">
              <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/plan-3.svg" alt="Ultimate"/>
        ...
        <div class="col-md-4 mt30">
          <div class="reviews-card pr-shadow">
            <div class="row v-center">
              ...
              <div class="col"> <span class="revbx-rl"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/envato.png" alt="review service logo"></span> </div>
            </div>

...
<body class="active-dark">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="hero-heading-sec">
                        <h2 class="wow fadeIn" data-wow-delay="0.3s"> <span>Art.</span> <span>Prints.</span> <span>Graphic.</span> <span>Branding.</span></h2>
                        <p class="wow fadeIn" data-wow-delay="0.6s">Graphic and branding solution for transforming and innovating businesses.</p>
                        ...
                        <div class="awards-block-tt  wow fadeIn" data-wow-delay="1s"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>hero/awards-logo.png" alt="awards-logo" class="img-fluid" /></div>
                    </div>
                </div>
                <div class="col-lg-7">
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-10">
                    <div class="common-heading">
                        ...
                        <p>Lorem Ipsum is <span class="text-radius text-light text-animation bg-b">simply dummy</span> text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown
                            printer took a galley of type and scrambled it to make a type specimen book. <span class="text-bold">Lorem Ipsum</span> is simply dummy text of the printing and typesetting industry. <span class="text-bold">Lorem Ipsum </span>                            is simply dummy text of the printing and typesetting industry.</p>
        ...
        <div class="container">
            <div class="row upset">
                ...
                <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-3-cus wow fadeInUp" data-wow-delay=".4s">
                    <div class="service-sec-list srvc-bg-nx srcl1">
                        <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/development.svg" alt="service">
                ...
                <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-3-cus wow fadeInUp" data-wow-delay=".6s">
                    <div class="service-sec-list srvc-bg-nx srcl2">
                        <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/ecommerce.svg" alt="service">
                        <h5 class="mb10">Branding</h5>
                        <ul class="-service-list">
                            <li> <a href="#">Logo </a> </li>
                            <li> <a href="#">Flyers</a> </li>
                            <li> <a href="#">Business Crads</a> </li>
                        </ul>
                        <p>Lorem Ipsum is text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500.</p>
                    </div>
                </div>
                <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-3-cus mt30- wow fadeInUp" data-wow-delay=".8s">
                    <div class="service-sec-list srvc-bg-nx srcl3">
                        <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/app.svg" alt="service">
                        <h5 class="mb10">Art Skechting</h5>
                        <ul class="-service-list">
                            <li> <a href="#">Oil </a> </li>
                ...
                <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-3-cus mt30- wow fadeInUp" data-wow-delay="1s">
                    <div class="service-sec-list srvc-bg-nx srcl4">
                        <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/tech.svg" alt="service">
                        <h5 class="mb10">Web Technologies</h5>
                        <ul class="-service-list">
                            <li> <a href="#">PHP </a> </li>
                ...
                <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-6-cus mt30- wow fadeInUp" data-wow-delay="1.2s">
                    <div class="service-sec-list srvc-bg-nx srcl5">
                        <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/seo.svg" alt="service">
            ...
            <div class="-cta-btn mt70">
                <div class="free-cta-title v-center zoomInDown wow" data-wow-delay="1.4s">
                    <p>Hire <span>Mazzy DAP Group</span></p>
        ...
        <div class="container">
            <div class="row justify-content-center t-ctr">
                <div class="col-lg-4 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/startup.svg" alt="years" class="img-fluid" />
                        </div>
                        <div class="statnumb">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/team.svg" alt="team" class="img-fluid" />
                        </div>
                        <div class="statnumb">
            ...
            <div class="row small t-ctr">
                <div class="col-lg-3 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/deal.svg" alt="happy" class="img-fluid" />
                        </div>
                        <div class="statnumb">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/computers.svg" alt="project" class="img-fluid" />
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/worker.svg" alt="work" class="img-fluid" />
                        </div>
                        <div class="statnumb">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="statistics mb0">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/customer-service.svg" alt="support" class="img-fluid" />
                        </div>
                        <div class="statnumb">
    ...
    <section class="why-choos-lg pad-tb deep-dark">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="common-heading text-l">
                        ...
                        <div class="itm-media-object mt40 tilt-3d">
                            <div class="media">
                                <div class="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/computers.svg" alt="icon" class="layer"></div>
                            ...
                            <div class="media mt40">
                                <div class="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/worker.svg" alt="icon" class="layer"></div>
                                <div class="media-body">
                            ...
                            <div class="media mt40">
                                <div class="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"> <img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/deal.svg" alt="icon" class="layer"></div>
                                <div class="media-body">
                ...
                <div class="col-lg-6">
                    <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="single-image bg-shape-dez wow fadeIn" data-wow-duration="2s"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>about/about-company.jpg" alt="image" class="img-fluid"></div>
                    ...
                    <div class="cta-card mt60 text-center">
                        ...
                        <a href="#" class="btn-outline bg-btn4 lnk mt30">Request A Quote    <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 center">
                    <div class="-cta-btn mt70">
                        <div class="free-cta-title v-center zoomInDown wow" data-wow-delay="1.4s">
                            <a href="#" class="btn-main bg-btn2 lnk">View More<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="clients-logos text-center col-12">
                        <ul class="row text-center clearfix">
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".2s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-1.png" alt="clients" class="img-fluid"></div>
                                <p>Shutter, USA</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".4s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-2.png" alt="clients" class="img-fluid"></div>
                                <p>Hipster, USA</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".6s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-3.png" alt="clients" class="img-fluid"></div>
                                <p>Happy, USA</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".8s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-4.png" alt="clients" class="img-fluid"></div>
                                <p>Opera Tours, USA</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-5.png" alt="clients" class="img-fluid"></div>
                                <p>Royale Stone, UK</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1.2s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-6.png" alt="clients" class="img-fluid"></div>
                                <p>QTP, Australia</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1.4s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-7.png" alt="clients" class="img-fluid"></div>
                                <p>PAPA, Malaysia</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1.6s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-8.png" alt="clients" class="img-fluid"></div>
                                <p>Coffee, Australia</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1.8s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-9.png" alt="clients" class="img-fluid"></div>
                                <p>Bakery, India</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-10.png" alt="clients" class="img-fluid"></div>
                                <p>Iconico, India</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2.2s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-11.png" alt="clients" class="img-fluid"></div>
                                <p>Tom N Jerry, UK</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2.4s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-12.png" alt="clients" class="img-fluid"></div>
                                <p>Arch, India</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2.6s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-13.png" alt="clients" class="img-fluid"></div>
                                <p>Aro Group, India</p>
                            </li>
                            <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2.8s">
                                <div class="brand-logo"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>client/clients-14.png" alt="clients" class="img-fluid"></div>
                                <p>Tom Group, India</p>
                            </li>
    ...
    <!--End Clients-->
    <?php include(ROOT_PATH . '/app/includes/relationships.php'); ?>
    <!--Start work-category-->
                    ...
                    <div class="work-card-set">
                        <div class="icon-set wow fadeIn" data-wow-delay=".2s">
                            <div class="work-card cd1">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-1.png" alt="Industries" /></div>
                                <p>Social Networking</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay=".4s">
                            <div class="work-card cd2">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-2.png" alt="Industries" /></div>
                                <p>Digital Marketing</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay=".6s">
                            <div class="work-card cd3">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-3.png" alt="Industries" /></div>
                                <p>Ecommerce Development</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay=".8s">
                            <div class="work-card cd4">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-4.png" alt="Industries" /></div>
                                <p>Video Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1s">
                            <div class="work-card cd5">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-5.png" alt="Industries" /></div>
                                <p>Banking Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1.2s">
                            <div class="work-card cd6">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-6.png" alt="Industries" /></div>
                                <p>Enterprise Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1.4s">
                            <div class="work-card cd7">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-7.png" alt="Industries" /></div>
                                <p>Education Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1.6s">
                            <div class="work-card cd8">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-8.png" alt="Industries" /></div>
                                <p>Tour and Travels</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1.8s">
                            <div class="work-card cd9">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-9.png" alt="Industries" /></div>
                                <p>Health Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="2s">
                            <div class="work-card cd10">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-10.png" alt="Industries" /></div>
                                <p>Event & Ticket</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="2.2s">
                            <div class="work-card cd11">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-11.png" alt="Industries" /></div>
                                <p>Restaurant Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="2.4s">
                            <div class="work-card cd12">
                                <div class="icon-bg"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>icons/icon-12.png" alt="Industries" /></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="owl-carousel testimonial-card-a pl25">
                        <div class="testimonial-card">
                            ...
                            <div class="client-thumbs mt30">
                                <div class="media v-center">
                                    <div class="user-image bdr-radius"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>user-thumb/girl.jpg" alt="girl" class="img-fluid" /></div>
                        ...
                        <div class="testimonial-card">
                            <div class="t-text">
                                <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it
                ...
                <div class="col-lg-12">
                    <div class="review-ref mt100">
                        ...
                        <div class="review-icons">
                            <a href="#" target="blank" class="wow fadeIn" data-wow-delay=".2s"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>about/reviews-icon-1.png" alt="review" class="img-fluid"></a>
                            <a href="#" target="blank" class="wow fadeIn" data-wow-delay=".4s"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>about/reviews-icon-2.png" alt="review" class="img-fluid"></a>
                            <a href="#" target="blank" class="wow fadeIn" data-wow-delay=".6s"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>about/reviews-icon-3.png" alt="review" class="img-fluid"></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="cta-area pad-tb">
        ...
        <div class="shape shape-a1"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>shape/shape-3.svg" alt="shape"></div>
        <div class="shape shape-a2"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>shape/shape-4.svg" alt="shape"></div>
        <div class="shape shape-a3"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>shape/shape-13.svg" alt="shape"></div>
        <div class="shape shape-a4"><img src="<?php echo BASE_URL . '/assets/open/images/'; ?>shape/shape-11.svg" alt="shape"></div>
    </section>
    <!--End CTA-->
    <?php 

        ...
        <div class="container-fluid m-pad">
            <div class="menu-header">
                ...
                <div class="custom-nav" role="navigation">
                    <ul class="nav-list">
                        <li><a href="<?php echo BASE_URL . '/'; ?>" class="menu-links">Home</a></li>
                        <li><a href="<?php echo BASE_URL . '/about'; ?>" class="menu-links">About</a></li>
                        ...
                        <li><a href="#" class="menu-links right-bddr">&nbsp;</a>
                            ...
                            <li class="contact-show"><a href="#" class="btn-round- trngl btn-br bg-btn"><i class="fas fa-phone-alt"></i></a>
                                <div class="contact-inquiry">
                                    <div class="contact-info-">
                                        <div class="contct-heading">Mazzy DAP Contacts</div>
                                        <div class="inquiry-card-nn hrbg">
                                            <div class="title-inq-c">FOR HR DEPARTMENT</div>
                                            <ul>
                                                <li class="mb0"><img src="<?php echo BASE_URL . '/assets/open/images'; ?>/flags/us.svg" alt="us office" class="flags-size"> <a href="tel:1111111111">+1-123-456-7890</a></li>
                                            </ul>
                                        </div>
                                        <div class="inquiry-card-nn">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="tel:1111111111"><img src="<?php echo BASE_URL . '/assets/open/images'; ?>/flags/us.svg" alt="us office" class="flags-size"> +1-123-456-7890</a>
                                                </li>
                                                <li>
                                                    <a href="tel:1111111111"><img src="<?php echo BASE_URL . '/assets/open/images'; ?>/flags/au.svg" alt="australia office" class="flags-size"> +1-123-456-7890</a>
                                                </li>
                                                <li><i class="fab fa-skype"></i><a href="skype:Mazzy DAP.company?call">Mazzy DAP.company</a></li>
                            ...
                            <li><a href="<?php echo BASE_URL . '/contact'?>" class="btn-br bg-btn3 btshad-b2 lnk">Request A Quote <span class="circle"></span></a></li>
                        </li>
                    </ul>
                </div>
            ...
            <nav id="main-nav">
                ...
                <ul class="bottom-nav">
                    ...
                    <li class="prb">
                        <a href="skype:Mazzy DAP.company?call">
